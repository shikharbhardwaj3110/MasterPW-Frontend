    ...
    return (
        <div style={{ minHeight: '8rem', display: 'flex', flexDirection: 'column', marginTop : '1rem' }}>
            <div class="cardbg text-light" style={{ flex: 2, paddingLeft: '2rem', paddingTop: '1rem', borderTopLeftRadius: '15px', borderTopRightRadius: '15px', paddingBottom : '1rem' }}>
                ...
                <h5 class="display-5" style={{ fontSize: '1.2rem', display : 'inline' }} >Password  :  {hidden ? '********' : props.utilPassword}</h5><i onClick={()=> setHidden(old => !old)} class="fas fa-eye-slash" style={{display : 'inline', paddingLeft : '1rem'}}></i>
    ...
    return (
        <div style={{ paddingLeft: '3rem', paddingRight: '3rem', paddingTop: '2rem' }} class="tablediv">
            <div style={{ border: '1px solid #e0e0e0', borderRadius: '15px', marginBottom : '2rem' }}>
                ...
                <div style={{ paddingLeft: '1rem', paddingTop: '2rem', paddingRight: '1rem' }}>
                    <div >

                        {
                            props.map((item, index) => {
                                return (
                                    <PasswordCard props={item}></PasswordCard>
                                )
                            })
                        }
